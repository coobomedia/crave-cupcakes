...
//	exit;
	...
	foreach($_SESSION['cats'] as $key=>$decor){
	...
	if( $_SESSION['cats']['wp_'.$cat_id]['customize_topper'] != '' || $_SESSION['cats']['wp_'.$cat_id]['packaging'] != NULL ){
...
add_action('woocommerce_cart_calculate_fees', function() {
	...
	foreach ($cat_wisw_pros as $cat_id => $cart_items) {
		...
		if(isset($_SESSION['cats']['wp_'.$cat_id]['packaging'])){
			$boxing_status = $_SESSION['cats']['wp_'.$cat_id]['packaging'];
	...
	WC()->cart->add_fee(__('Packaging Price', 'hello-elementor'), $_SESSION['packaging_price']);
