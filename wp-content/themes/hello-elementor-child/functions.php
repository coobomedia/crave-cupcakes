...
function update_packaging_callback()
{
    ...
    $_SESSION['cats']['wp_' . $packaging_term]['packaging'] = $packaging_status;
...
function wct_get_time_values_callback()
{
    ...
    */
    ...
    if ($order_type == "pickup") {
                ...
                if ($production_window_day[$new_check_key] > $new_slots[$new_check_key] && $production_window_day[$new_check_key] >= 1) {
                    ...
                    if ($date_now == $selected_date) {
                        ...
                        if ($time_now < $i) {
                            ...
                            //echo "We are Here<br>";
                            $output .= "<option value='" . date("h:i A", $i) . " - " . date("h:i A", $i + 1800) . "'>" . date("h:i A", $i) . " - " . date("h:i A", $i + 1800) . "</option>";
                            //echo "If 1 <br>";
                            $check = 1;
        ...
        for ($i = $open_time; $i < ($close_time - 10800); $i += 7200) {
...
function update_session_values_cart_decoration_callback()
{
    ...
    $_SESSION['cats']["wp_" . $_POST['category_id']]['decor_type'] = stripslashes($_POST['decor_type']);
    $_SESSION['cats']["wp_" . $_POST['category_id']]['decor_color_input_1'] = $_POST['color_1'];
    $_SESSION['cats']["wp_" . $_POST['category_id']]['decor_color_input_2'] = $_POST['color_2'];

    $_SESSION['cats']["wp_" . $_POST['category_id']]['decor_color_1'] = $_POST['color_code_1'];
    $_SESSION['cats']["wp_" . $_POST['category_id']]['decor_color_2'] = $_POST['color_code_2'];


    $_SESSION['cats']["wp_" . $_POST['category_id']]['decor_input_image_2'] = $_POST['image'];
...
function customize_topper_callback()
{
    ...
    if ($topper_status == null || $topper_status == '') {
        unset($_SESSION['cats']["wp_" . $term_id]['decor_type']);
        unset($_SESSION['cats']["wp_" . $term_id]['decor_color_1']);
        unset($_SESSION['cats']["wp_" . $term_id]['decor_color_input_1']);
        unset($_SESSION['cats']["wp_" . $term_id]['decor_color_2']);
        unset($_SESSION['cats']["wp_" . $term_id]['decor_color_input_2']);
        unset($_SESSION['cats']["wp_" . $term_id]['decor_input_image_2']);
...
function store_session_date_callback()
{
    ...
    if (isset($_POST['order_type'])) {
        ...
        $_SESSION['decor_type_'] = $_POST['decor_type'];
    ...
    if (isset($_POST['decor_type'])) {
        $_SESSION['packaging'] = $_POST['packaging_opts'];
        $_SESSION['cats']["wp_" . $_POST['current_cat_id']]['packaging'] = $_POST['packaging_opts'];

        if ($_POST['decor_type'] != null) {
            $_SESSION['decor_type'] = $_POST['decor_type'];
            $_SESSION['decor_color_1'] = $_POST['decor_color_1'];
            $_SESSION['decor_color_2'] = $_POST['decor_color_2'];
            $_SESSION['decor_input_image_1'] = $_POST['decor_input_image_1'];
            $_SESSION['decor_input_image_2'] = $_POST['decor_input_image_2'];
            $_SESSION['decor_type_'] = $_POST['decor_type'];
            echo "<pre>";
            print_r($_SESSION['decor_type_']);
            echo "</pre>";

            //if(isset($_POST['packaging_opts'])){

            $_SESSION['cats']["wp_" . $_POST['current_cat_id']]['decor_type'] = $_POST['decor_type'];
            $_SESSION['cats']["wp_" . $_POST['current_cat_id']]['decor_color_1'] = $_POST['decor_color_code_1'];
            $_SESSION['cats']["wp_" . $_POST['current_cat_id']]['decor_color_input_1'] = $_POST['decor_color_input_1'];
            $_SESSION['cats']["wp_" . $_POST['current_cat_id']]['decor_color_2'] = $_POST['decor_color_code_2'];
            $_SESSION['cats']["wp_" . $_POST['current_cat_id']]['decor_color_input_2'] = $_POST['decor_color_input_2'];
            //$_SESSION['cats']["wp_".$_POST['current_cat_id']]['decor_input_image_1'] = $_POST['decor_input_image_1'];
            $_SESSION['cats']["wp_" . $_POST['current_cat_id']]['decor_input_image_2'] = $_POST['decor_input_image_2'];
            $_SESSION['cats']["wp_" . $_POST['current_cat_id']]['customize_topper'] = $_POST['customize_topper'];
        }
...
function destroy_decorations($cart_cat_ids)
{
    ...
    foreach ($cart_ids as $cart_item) {
        ...
        unset($_SESSION['cats']["wp_" . $cart_item]['decor_type']);
        unset($_SESSION['cats']["wp_" . $cart_item]['decor_color_input_1']);
        unset($_SESSION['cats']["wp_" . $cart_item]['decor_color_input_2']);
        unset($_SESSION['cats']["wp_" . $cart_item]['decor_color_1']);
        unset($_SESSION['cats']["wp_" . $cart_item]['decor_color_2']);
        unset($_SESSION['cats']["wp_" . $cart_item]['decor_input_image_2']);
