...
if(isset($_SESSION['cats']["wp_".$_SESSION['current_cat_id']]['customize_topper'])){
	$customize_topper = $_SESSION['cats']["wp_".$_SESSION['current_cat_id']]['customize_topper'];

	if($customize_topper=="Customize Topper"){
		unset($_SESSION['cats']["wp_".$_SESSION['current_cat_id']]['customize_topper']);
		unset($_SESSION['cats']["wp_".$_SESSION['current_cat_id']]['decor_type']);
		unset($_SESSION['cats']["wp_".$_SESSION['current_cat_id']]['decor_color_1']);
		unset($_SESSION['cats']["wp_".$_SESSION['current_cat_id']]['decor_color_input_1']);
		unset($_SESSION['cats']["wp_".$_SESSION['current_cat_id']]['decor_color_2']);
		unset($_SESSION['cats']["wp_".$_SESSION['current_cat_id']]['decor_color_input_2']);
		unset($_SESSION['cats']["wp_".$_SESSION['current_cat_id']]['decor_input_image_2']);
	}
}
        ...
        <div class="p-and-d">
            <div class="p_and_d_box">
                    ...
                    <div class="packaging_opts">
                        ...
                        <div class="option">
                            ...
                            <label class="label postField" id="individual_box" for="individual_box">
                                <span class="input-radio-faux"></span>Individually Boxed</label>
                ...
                <div class="decorations">
                    ...
                    if( !$qty_check || $_SESSION['date_sec'] == date('Y-m-d', time())  ) {
                    ...
                    ?>
                    <input <?php echo (!$qty_check || $_SESSION['date_sec'] == date('Y-m-d', time())) ? 'disabled' : 'enabled'; ?> type="checkbox" id='customize_topper' name="customize_topper" value='Customize Topper'/>
