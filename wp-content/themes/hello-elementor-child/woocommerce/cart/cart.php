                ...
                <div>
                    ...
                    foreach ($cat_wisw_pros as $cat_id => $cart_items) {
                        ...
                        <div class="<?php echo $term->slug; ?> group-wrapper">
                            ...
                            $color_code = "#55B7B3";
                            $op = 1;
                            $decor_type_text = $_SESSION['cats']["wp_" . $term->term_id]['decor_type'];
                            $disabled = "";
                            $color_1 = $_SESSION['cats']["wp_" . $term->term_id]['decor_color_input_1'];
                            $color_2 = $_SESSION['cats']["wp_" . $term->term_id]['decor_color_input_2'];
                            if ($cat_qty < 12) {
                                if($cat_id!=35){
                                    $color_code = "#E43945";
                                    ...
                                    $_SESSION['cats']["wp_" . $term->term_id]['decor_type'] = "";
                                    $_SESSION['cats']["wp_" . $term->term_id]['decor_color_input_1'] ="";
                                    $_SESSION['cats']["wp_" . $term->term_id]['decor_color_input_2']="";

                                    $_SESSION['cats']["wp_" . $term->term_id]['decor_color_1'] ="";
                                    $_SESSION['cats']["wp_" . $term->term_id]['decor_color_2']="";
                                }
                            }
                            ...
                            if(isset($_SESSION['cats']['wp_'.$term->term_id]['packaging'])){
                                $boxing_status = $_SESSION['cats']['wp_'.$term->term_id]['packaging'];
                            ...
                            if ($packaging_opt == 1) :
                                ...
                                <div class="packaging-cart">
                                    ...
                                    <div class="standardbox">
                                        <input class="packaging_status" type="radio" data-term_id="<?php echo $term->term_id; ?>" value="standard_box" name="packaging_<?php echo $packaging; ?>" id="standard-box-cart_<?php echo $packaging; ?>" <?php echo $not_boxing; ?>>
                                        <label for="standard-box-cart_<?php echo $packaging; ?>">Standard Box</label>
                                    </div>
                                    <div class="individuallyboxed ">
                                        <input class="packaging_status" type="radio" data-term_id="<?php echo $term->term_id; ?>" value="individual_box"  name="packaging_<?php echo $packaging; ?>" id="individuallyboxed_<?php echo $packaging; ?>" <?php echo $boxing; ?>>
                            ...
                            if ($check_topping == 1) :
                                ...
                                <div class="decorations-cart">
                                    ...
                                    // }
                                    $customize_topper = $_SESSION['cats']["wp_" . $term->term_id]['customize_topper'];
                                    ...
                                    <div class="decor_type_wrapper" id="decor_type_input_<?php echo $term->term_id ?>" style="<?php echo $customize_topper_style; ?>">

                                        <?php $decor_type = get_field("_decor_type", "option"); ?>

                                        <select name="decor_type" data-cat_id="<?php echo $term->term_id; ?>" class="decor_type_<?php echo $term->term_id; ?> cart_decoration" id="decor_type_<?php echo $packaging; ?>" <?php echo $disabled; ?> style="border-color:<?php echo $color_code; ?>; opacity: <?php echo $op; ?>;">
                                    ...
                                    <div class="decor_color_wrapper" id="decor_color_input_<?php echo $term->term_id ?>" style="<?php echo $customize_topper_style; ?>">
                                        <div class="color_1">
                                            <?php $decoration_colors = get_field("decoration_colors", "option"); ?>
                                            <select
                                                    name="decor_color_1"
                                                    data-cat_id="<?php echo $term->term_id; ?>"
                                                    class="decor_color_1_<?php echo $term->term_id; ?> cart_decoration"
                                        ...
                                        <div class="color_2">
                                            ...
                                            <select name="decor_color_2" data-cat_id="<?php echo $term->term_id; ?>" class="decor_color_2_<?php echo $term->term_id; ?> cart_decoration" id="decor_color_2" <?php echo $disabled; ?> style="border-color:<?php echo $color_code; ?>; opacity: <?php echo $op; ?>;">
                                    ...
                                    <?php if($cat_id==35){ ?>
                                        <div class="decor-preview" id="decor_images_input_<?php echo $term->term_id ?>" style="<?php echo $customize_topper_style; ?>">
                                            <div class="decor_image">
                                                <div class="special-deco-bx" style="min-height: auto">
                                                    <div data-kind="image_included" class="clonecake changeColor_1" id="cake_deco_base" style="background-color: <?php echo $_SESSION['cats']["wp_" . $term->term_id]['decor_color_1']; ?>; float: left; width: 50px;height: 50px;position: relative;">
                                                        ...
                                                        <div id="cake_deco_top" class="changeColor_1" style="background-color: <?php echo $_SESSION['cats']["wp_" . $term->term_id]['decor_color_1']; ?>; width: 35.0px;height: 35.0px;position: absolute;top: 8.0px;left: 8.0px;border-radius: 45.0px">
                                                            <img src="<?php echo $_SESSION['cats']["wp_" . $term->term_id]['decor_input_image_2']; //$decor_image_1;
                                            ...
                                            ?>" alt="">-->
                                            <div class="special-deco-bx" style="min-height: auto">
                                                <div data-kind="image_included" class="clonecake changeColor_2" id="cake_deco_base_2" style="background-color: <?php echo $_SESSION['cats']["wp_" . $term->term_id]['decor_color_2']; ?>; float: left; width: 50px;height: 50px;position: relative;">
                                                    <img src="/wp-content/uploads/2022/10/base.png" class="cakeimages" style="padding: 0; position: absolute; top: 0; left: 0; max-width: 100%" onerror="this.src = '/wp-content/uploads/2022/10/base.png'">
                                                    <div id="cake_deco_top_2" class="changeColor_2" style="background-color: <?php echo $_SESSION['cats']["wp_" . $term->term_id]['decor_color_2']; ?>; width: 35.0px;height: 35.0px;position: absolute;top: 8.0px;left: 8.0px;border-radius: 45.0px">
                                                        <img src="<?php echo $_SESSION['cats']["wp_" . $term->term_id]['decor_input_image_2']; ?>" class="cakeimages changeImage" style="width: 30.0px; height: 30.0px; position: absolute; top: 3.0px; left: 3.0px;" onerror="this.src = '/wp-content/uploads/2022/10/base.png'">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="wrapper_customize_topper ">
                                    <?php
                                    if(isset($_SESSION['cats']["wp_" . $term->term_id]['decor_type']) && $_SESSION['cats']["wp_" . $term->term_id]['decor_type']!=NULL){
                                    ...
                                    <input <?php echo (!$qty_check) ? 'disabled' : 'enabled'; ?> type="checkbox" data-id="<?php echo $term->term_id ?>" class="customize_topper" id="customize_topper_<?php echo $packaging; ?>" name="customize_topper_<?php echo $packaging; ?>" value="Customize Topper" <?php echo $customizer_topper_1; ?> />
