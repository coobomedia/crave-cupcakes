jQuery(document).ready(function($){
	...
	jQuery(".cart-wrapper").on("click", ".customize_topper", function(){
		...
		if(jQuery(this).prop("checked") == true){
			jQuery("#decor_type_input_" + cat_id).css("visibility", "visible");
			jQuery("#decor_color_input_" + cat_id).css("visibility", "visible");
			jQuery("#decor_images_input_" + cat_id).css("visibility", "visible");
			...
			jQuery("#decor_type_input_" + cat_id).css("visibility", "hidden");
			jQuery("#decor_color_input_" + cat_id).css("visibility", "hidden");
			jQuery("#decor_images_input_" + cat_id).css("visibility", "hidden");
...
jQuery(".cart-wrapper").on('change', '.cart_decoration', function(){ 
	...
	//console.log(cat_id);
	var decor_type_value = jQuery(".decor_type_" + cat_id).val(); 
	var decor_color_1_value = jQuery(".decor_color_1_" + cat_id).val();
	
	var decor_colorCode_1_value = jQuery(".decor_color_1_" + cat_id).find(":selected").attr('data-color');
	var decor_colorCode_2_value = jQuery(".decor_color_2_" + cat_id).find(":selected").attr('data-color');
	console.log('c1: ', decor_colorCode_1_value);
	console.log('c2: ', decor_colorCode_2_value);


	var decor_color_2_value = jQuery(".decor_color_2_" + cat_id).val();
	var image = jQuery(".decor_type_" + cat_id).find(':selected').attr('data-image'); 
