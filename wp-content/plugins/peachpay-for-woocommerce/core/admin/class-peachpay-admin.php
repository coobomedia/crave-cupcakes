...
class PeachPay_Admin {
	...
	public function add_admin_menus() {
		...
		add_submenu_page(
			'peachpay',
			__( 'Home', 'peachpay-for-woocommerce' ),
			__( 'Home', 'peachpay-for-woocommerce' ),
			'manage_woocommerce',
			'peachpay&tab=home',
			array( __CLASS__, 'do_admin_page' )
		...
		add_submenu_page(
			'peachpay',
			__( 'Payments', 'peachpay-for-woocommerce' ),
			__( 'Payments', 'peachpay-for-woocommerce' ),
			'manage_woocommerce',
		...
		add_submenu_page(
			...
			__( 'Related products', 'peachpay-for-woocommerce' ),
			'manage_woocommerce',
			'peachpay&tab=related_products',
			array( __CLASS__, 'do_admin_page' )
		);
		add_submenu_page(
			'peachpay',
			__( 'Express checkout', 'peachpay-for-woocommerce' ),
			__( 'Express checkout', 'peachpay-for-woocommerce' ),
			'manage_woocommerce',
			'peachpay&tab=express_checkout',
			array( __CLASS__, 'do_admin_page' )
		);
		add_submenu_page(
			'peachpay',
