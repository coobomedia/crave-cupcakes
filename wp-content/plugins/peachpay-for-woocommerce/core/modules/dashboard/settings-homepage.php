...
function peachpay_render_settings_homepage() {
	?>
	<div class='pp-settings-homepage-container'>
		<div class='pp-settings-homepage'>
			<?php
...
function peachpay_homepage_section( $homepage_section ) {
	?>
	<div class='pp-homepage-section pp-homepage-section-<?php echo esc_attr( $homepage_section ); ?> pp-flex-col pp-gap-24'>
		<?php
...
function peachpay_homepage_heading( $homepage_section ) {
	...
	<div class='pp-flex-row pp-jc-sb'>
		<div class='pp-flex-row pp-homepage-section-title'>
			<?php
...
function peachpay_homepage_section_content( $homepage_section ) {
	?>
	<div class='pp-homepage-section-content'>
		<?php
...
function peachpay_homepage_analytics() {
	...
	foreach ( $analytics_cards as $analytics_card ) {
		?>
		<div class='pp-homepage-section-card'>
			<div class='pp-homepage-section-card-title'>
				<?php echo esc_html( $analytics_card['title'] ); ?>
			</div>
			<div class='pp-homepage-section-analytics-data'>
				<?php
				if ( is_array( $analytics_card['data'] ) ) {
					peachpay_homepage_analytics_render_array_data( $analytics_card['data'] );
				} else {
					?>
					<div class='pp-homepage-section-analytics-single-data'>
			...
			<div class='pp-homepage-section-analytics-description'>
...
function peachpay_homepage_analytics_render_array_data( $data_array ) {
	?>
	<div class='pp-homepage-section-analytics-array-data-container'>
		<?php
		foreach ( $data_array as $data ) {
			?>
			<div class='pp-flex-col pp-ai-center'>
				<div class='pp-homepage-section-analytics-array-data-label'>
					<?php echo esc_html( $data['title'] ); ?>
				</div>
				<div class='pp-homepage-section-analytics-array-data'>
...
function peachpay_homepage_payment_methods() {
	$data = array(
		array(
			...
			'heap_id'     => 'stripe',
			'hash'        => '#stripe',
			'main_logo'   => peachpay_url( '/public/img/marks/stripe.svg' ),
			...
			'sub_logos'   => array(
				peachpay_url( '/public/img/marks/cards.svg' ),
				...
				peachpay_url( '/public/img/marks/us_banks.svg' ),
				peachpay_url( '/public/img/marks/bancontact-card.svg' ),
				peachpay_url( '/public/img/marks/giropay-card.svg' ),
				peachpay_url( '/public/img/marks/sofort-card.svg' ),
				peachpay_url( '/public/img/marks/p24-card.svg' ),
				peachpay_url( '/public/img/marks/eps-card.svg' ),
				peachpay_url( '/public/img/marks/ideal-card.svg' ),
			),
		),
		array(
			'title'       => 'PayPal',
			'heap_id'     => 'paypal',
			'hash'        => '#paypal',
			'main_logo'   => peachpay_url( '/public/img/marks/paypal.svg' ),
		...
		array(
			...
			'heap_id'     => 'square',
			'hash'        => '#square',
			'main_logo'   => peachpay_url( '/public/img/marks/square.svg' ),
			...
			'sub_logos'   => array(
				peachpay_url( '/public/img/marks/cards.svg' ),
				peachpay_url( '/public/img/marks/applepay-card.svg' ),
				peachpay_url( '/public/img/marks/googlepay-card.svg' ),
			),
		),
		array(
			'title'       => 'Authorize.net',
			'heap_id'     => 'authnet',
			'hash'        => '#authnet',
			'main_logo'   => peachpay_url( '/public/img/marks/authnet.png' ),
			'connection'  => peachpay_authnet_enabled(),
			'description' => 'Connect your Authorize.net account to PeachPay to start accepting card payments.',
			'sub_logos'   => null,
		),
		array(
			'title'       => 'Amazon Pay',
			'heap_id'     => 'amazonpay',
			'hash'        => '#amazonpay',
			'main_logo'   => peachpay_url( '/public/img/marks/amazon-pay-card.svg' ),
		...
		array(
			...
			'hash'        => '#peachpay',
			'main_logo'   => peachpay_url( '/public/img/marks/purchase_order.svg' ),
	...
	foreach ( $data as $value ) {
		?>
		<div class='pp-homepage-section-card'>
			<div class='pp-homepage-section-card-image-container'>
				<img src='<?php echo esc_attr( $value['main_logo'] ); ?>'/>
			</div>
			<div class='pp-flex-row pp-jc-sb pp-ai-center'>
				<div class='pp-homepage-section-card-title'>
					<?php echo esc_html( $value['title'] ); ?>
				</div>
				<a class='pp-homepage-section-card-button' href='<?php esc_url( PeachPay_Admin::admin_settings_url( 'peachpay', 'payment', '', $value['hash'] ) ); ?>'
					<?php
					if ( $value['connection'] ) {
			...
			<div class='pp-homepage-section-card-description'>
				<?php echo esc_html( $value['description'] ); ?>
			</div>
			<?php
			if ( $value['sub_logos'] ) {
				?>
				<div class='pp-homepage-section-card-sub-logos'>
					<?php
					...
					if ( 4 < count( $value['sub_logos'] ) ) {
						?>
						<div class='pp-homepage-section-card-sub-logos-toggle'>See more</div>
						<?php
					}
					?>
				</div>
	...
	foreach ( $data as $value ) {
		...
		<div class='pp-homepage-section-card'>
			...
			<div class='pp-flex-row pp-jc-sb'>
				...
				<a class='pp-homepage-section-card-button' href='<?php echo esc_url( $value['url'] ); ?>'
					<?php
					if ( $value['connection'] ) {
						echo esc_attr( 'enabled' );
					}
...
function peachpay_homepage_section_view_more( $homepage_section ) {
	...
	?>
	<a class='peachpay_homepage_view_more pp-flex-row pp-gap-4 pp-ai-center' data-heap='<?php echo 'home_view_' . esc_html( $homepage_section ); ?>' href='<?php esc_url( PeachPay_Admin::admin_settings_url( $page, $tab, $section ) ); ?>'>
