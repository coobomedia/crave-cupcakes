...
abstract class PeachPay_Admin_Tab extends WC_Settings_API {
	...
	public static function get_url() {
		if ( null === self::$settings_instance ) {
			self::$settings_instance = new static( true );
		}

		return admin_url( 'admin.php?page=peachpay&section=' . self::$settings_instance->get_section() . '&tab=' . self::$settings_instance->get_tab() );
	}

	/**
	 * Instance of the class used for settings only.
	 *
	...
	public static function get_setting( $setting = '' ) {
		...
		return self::$settings_instance->get_option( $setting );
	}
}
