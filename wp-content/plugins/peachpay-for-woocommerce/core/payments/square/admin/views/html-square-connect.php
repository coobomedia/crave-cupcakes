		...
		<?php if ( peachpay_square_connected() ) : ?>
			<?php if ( peachpay_square_merchant_permission_version() < peachpay_square_permission_version() ) : ?>
				<div class="tooltip pp-w-100">
					<a class="update-payment-button pp-w-100" href="<?php echo esc_url( peachpay_square_signup_url() ); ?>">
			...
			<a class="unlink-payment-button" href="<?php echo esc_url( admin_url( 'admin.php?page=peachpay&tab=payment&unlink_square#square' ) ); ?>" >
				<?php esc_html_e( 'Unlink Square', 'peachpay-for-woocommerce' ); ?>
			</a>

		<?php else : ?>
			<a class="connect-payment-button" href="<?php echo esc_url( peachpay_square_signup_url() ); ?>">
				<span><?php esc_html_e( 'Connect with Square', 'peachpay-for-woocommerce' ); ?></span>
			</a>
		<?php endif; ?>
	</div>
