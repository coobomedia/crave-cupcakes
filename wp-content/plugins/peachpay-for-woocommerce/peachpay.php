 ...
 * Description: PeachPay is supercharging WooCommerce checkout and payments. Connect and manage your payments no matter what provider, create custom checkout flows, and leverage checkout analytics to increase sales.
 * Version: 1.88.0
 * Author: PeachPay, Inc.
...
function peachpay_authorize_url() {
	...
	$return_url = peachpay_api_url( ( peachpay_is_staging_site() || peachpay_is_local_development_site() ) ? 'test' : 'prod' ) . "activation/verify?state=$home_url&wp_admin_url=$site_url";
...
function peachpay_feature_support_record() {
	...
	$base_features = array(
		...
		'bacs_method'              => peachpay_get_passthrough_gateway_settings( $bacs_gateway ),
